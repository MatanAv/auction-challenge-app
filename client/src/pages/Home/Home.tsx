        ...
        <div className={styles.terms}>
            ...
            <div className={styles.terms_section}>
                ...
                <ul>
                    ...
                    <li>בתחילת הניסוי תתבקש להזין את מספר תעודת הזהות שלך לצורך הסכמה לניסוי בלבד.</li>
                    <li>לאחר ההזדהות, יינתן לך מספר משתמש אקראי, ונתוניך ישויכו למספר זה בלבד.</li>
                    <li>הקישור בין תעודת הזהות למספר המשתמש ישמר בנפרד וישמש אך ורק לצורך הסכמה לניסוי.</li>
                </ul>
            </div>
