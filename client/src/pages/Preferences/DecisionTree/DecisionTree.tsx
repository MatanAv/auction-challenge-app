...
const Question3Description = () => (
    <div className={styles.question_description}>
        <h4 style={{ marginBottom: '8px' }}>נניח שניתנה לך לבחור האפשרות בין קבלת תשלום היום או תשלום בעוד 12 חודשים.</h4>
        <p>כעת נציג בפניכם 5 מצבים.</p>
        <p>
            התשלום היום זהה בכל אחד מהמצבים הללו. התשלום בעוד 12 חודשים שונה בכל מצב. עבור כל אחד מהמצבים הללו נרצה לדעת באיזה אפשרות תבחרו.
            אנא הניחו שאין אינפלציה, כלומר המחירים העתידיים זהים למחירים של היום.
        </p>
    </div>
);
