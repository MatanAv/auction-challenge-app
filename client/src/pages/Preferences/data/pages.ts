...
export const pages: Record<number, Page> = {
    ...
    2: {
        ...
        minValue: 'לא מוכן לחלוטין לקחת סיכונים',
        maxValue: 'מוכן מאוד לקחת סיכונים',
        valueType: 'rating'
    },
    3: {
    ...
    10: {
        ...
        options: [
            { value: 0, label: 'לא מעניקים מתנה' },
            { value: 5, label: 'מעניקים את המתנה ששווה 5$' },
            { value: 10, label: 'מעניקים את המתנה ששווה 10$' },
            { value: 15, label: 'מעניקים את המתנה ששווה 15$' },
            { value: 20, label: 'מעניקים את המתנה ששווה 20$' },
            { value: 25, label: 'מעניקים את המתנה ששווה 25$' },
            { value: 30, label: 'מעניקים את המתנה ששווה 30$' }
        ]
    },
    11: {
        numOfSubPages: 2,
    ...
    12: {
        ...
        minValue: 'לא מוכן כלל לשאת בעלויות',
        maxValue: 'מוכן מאוד לשאת בעלויות',
        valueType: 'rating'
    }
} as const;
